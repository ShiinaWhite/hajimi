...
# 缓存配置
CACHE_EXPIRY_TIME = int(os.environ.get("CACHE_EXPIRY_TIME", "0"))  # 默认缓存 6 小时 (21600 秒)
MAX_CACHE_ENTRIES = int(os.environ.get("MAX_CACHE_ENTRIES", "0"))  # 默认最多缓存500条响应
PRECISE_CACHE = os.environ.get("PRECISE_CACHE", "true").lower() in ["true", "1", "yes"] #是否取所有消息来算缓存键
